...
public class ItemGenerator : MonoBehaviour
{
    ...
    public void Awake()
    {
        ItemAgent.GenerateItem(new Vector3(2, 0), new HealthPotion { amount = 10, isStackable = true, itemType = "HealthPotion" });
        ItemAgent.GenerateItem(new Vector3(-3, -4), new Medkit { amount = 1, isStackable = false, itemType = "Medkit" });
